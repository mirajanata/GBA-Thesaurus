...
let DESC_INSPIRE = {};
let DESC_LINKEDDATA = {};
let GeologicUnitDesc = {};
let structureDesc = {};
let GeologicTimeScaleDesc = {};
let lithologyDesc = {};
let tectonicunitDesc = {};
let mineralDesc = {};
let TITLE_SEARCHRESULTS = '';
let HITS_SEARCHRESULTS = '';
let LABEL_BIBLREF = '';
let APPS = '';
let TOPIC = '';
let DB_QUERY = '';
...
let SEM_REL = '';
let descriptions_H = '';
let scientificReferences_H = '';
let semanticRelations_H = '';
let dataLinks_H = '';
let visualization_H = '';
let location_H = '';
let creator_H = '';

let LIST_THESAURUS_PROJECTS = [];

function loadLangDE() {
    LABEL_LICENSE = 'Nutzungsbedingungen';
    LABEL_DISCLAIMER = 'Haftungsausschluss';
    LABEL_SERVICES = 'Services';
    LABEL_CONTACT = 'Kontakt';
    TITLE_SEARCHRESULTS = 'Suchergebnisse';
    HITS_SEARCHRESULTS = '0 Treffer zu ';
    LABEL_BIBLREF = 'Quellverzeichnis';
    IMG_GBALOGO = 'gbaLogo50.png';
    APPS = 'Anwendungen';
    TOPIC = 'Thema';
    DB_QUERY = 'Datenbankabfrage (SPARQL)';
    EXAMPLE_QUERY = 'Beispiele f&uuml;r Abfragen';
    SEM_REL = 'Verwandte Begriffe, Relationen';
    descriptions_H = 'Beschreibungen';
    scientificReferences_H = 'Quellverweise';
    semanticRelations_H = 'Semantische Relationen';
    dataLinks_H = 'Downloads';
    visualization_H = 'Grafische Darstellung';
    location_H = 'Ortsbezug';
    creator_H = 'Bearbeitung';
    TITLE_THES_2 = 'ein kontrolliertes Vokabular geowissenschaftlicher Begriffe';
    DESC_THESAURUS = '..zweisprachig (Deutsch, Englisch), wie sie in den Textpublikationen und Karten der Geologischen Bundesanstalt verwendet werden<br>..entworfen als Wissensrepr&auml;sentation der Geologischen Bundesanstalt, im Gegensatz zu nationalen und internationalen Standards, Klassifikationen oder Lexika<br>..formatiert als <a href="http://www.w3.org/2004/02/skos/" title="SKOS Simple Knowledge Organization System" target="_blank">SKOS</a> Konzepte (Begriffe, einschlie&szlig;lich Synonyme), mit eigenen Web-Adressen &#8594; <a href="http://de.wikipedia.org/wiki/Uniform_Resource_Identifier" title="URI Uniform Resource Identifier" target="_blank">URI\'s</a><br>..definiert durch polyhierarchische Beziehungen als &uuml;ber-, untergeordnete, und verwandte Konzepte innerhalb eines Themenbereichs, mit Beschreibungen und Quellenangabe &#8594; <a href="http://resource.geolba.ac.at/thesaurus/ref.html" target="_blank">Literaturverzeichnis</a>';
