    ...
    initApps: function (uri) {
        ...
        $('#appsBody1').append(`
                                        <div class="apps">
                                            ...
                                            <a href="d3_tree.html?uri=${uri}&lang=${lang.ID}" title="visual tree" class="card-link">
                                                <br>Tree<br>diagram
                                            </a>
                                        </div>`);
        ...
        $('#appsBody1').append(`
                                        <div class="apps">
                                            ...
                                            <a href="d3_radial.html?uri=${uri}&lang=${lang.ID}" title="radial diagram" class="card-link">
                                                <br>Radial<br>diagram
                                            </a>
                                        </div>
                                        `);
        ...
        $('#appsBody1').append(`
                                        <div class="apps">
                                            ...
                                            <a href="d3_circle.html?uri=${uri}&lang=${lang.ID}" title="visual clusters" class="card-link">
                                                <br>Cluster<br>diagram
                                            </a>
                                        </div>
                                        `);
    }
